define("@scom/sc-core/contracts/@openzeppelin/contracts/token/ERC20/ERC20.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("@scom/sc-core/contracts/@openzeppelin/contracts/token/ERC20/ERC20.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/@openzeppelin/contracts/token/ERC20/ERC20.json.ts"], function (require, exports, eth_contract_1, ERC20_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/AuditorInfo.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/AuditorInfo.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/AuditorInfo.json.ts"], function (require, exports, eth_contract_2, AuditorInfo_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/Authorization.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/Authorization.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/Authorization.json.ts"], function (require, exports, eth_contract_3, Authorization_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/DomainInfo.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/DomainInfo.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/DomainInfo.json.ts"], function (require, exports, eth_contract_4, DomainInfo_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/ModuleInfo.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/ModuleInfo.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/ModuleInfo.json.ts"], function (require, exports, eth_contract_5, ModuleInfo_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/ProjectInfo.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/ProjectInfo.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/ProjectInfo.json.ts"], function (require, exports, eth_contract_6, ProjectInfo_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectInfo extends eth_contract_6.Contract {
        ...
        assign() {
            ...
            let setPackageVersionToAuditFailed_send = async (params) => {
                let result = await this.send('setPackageVersionToAuditFailed', setPackageVersionToAuditFailedParams(params));
                return result;
            };
            let setPackageVersionToAuditFailed_call = async (params) => {
            ...
            let setPackageVersionToAuditPassed_send = async (params) => {
                let result = await this.send('setPackageVersionToAuditPassed', setPackageVersionToAuditPassedParams(params));
                return result;
            };
            let setPackageVersionToAuditPassed_call = async (params) => {
...
define("@scom/sc-core/contracts/Scom.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/sc-core/contracts/Scom.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/sc-core/contracts/Scom.json.ts"], function (require, exports, eth_contract_7, Scom_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Scom = void 0;
    class Scom extends eth_contract_7.Contract {
        ...
        deploy(params) {
            return this.__deploy([params.minter, params.initSupplyTo, this.wallet.utils.toString(params.initSupply), this.wallet.utils.toString(params.totalSupply)]);
        }
        parseApprovalEvent(receipt) {
            return this.parseEvents(receipt, "Approval").map(e => this.decodeApprovalEvent(e));
        }
...
define("@scom/sc-core/contracts/index.ts", ["require", "exports", "@scom/sc-core/contracts/@openzeppelin/contracts/token/ERC20/ERC20.ts", "@scom/sc-core/contracts/AuditorInfo.ts", "@scom/sc-core/contracts/Authorization.ts", "@scom/sc-core/contracts/DomainInfo.ts", "@scom/sc-core/contracts/ModuleInfo.ts", "@scom/sc-core/contracts/ProjectInfo.ts", "@scom/sc-core/contracts/Scom.ts"], function (require, exports, ERC20_1, AuditorInfo_1, Authorization_1, DomainInfo_1, ModuleInfo_1, ProjectInfo_1, Scom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
