    ...
    assign() {
        ...
        let sales_call = async (param1, options) => {
            ...
            return {
                ...
                privateSaleEndTime: new eth_contract_1.BigNumber(result.privateSaleEndTime),
                semiPrivateSaleEndTime: new eth_contract_1.BigNumber(result.semiPrivateSaleEndTime),
